...
然后用request模块直接把它爬取下来得到tx .txt文档
...
首先核对交易的地址：就是mifsbboEK2wCh1EM1qLbm21Jsr9mRQNXbd是之前创建的测试地址

其中包含的内容：hash值，交易的地址，交易的总数，给矿工的费用，收到的时间就是7-28日当天，接下是input，input里面有签名，并且指向使用哪个交易的output，output包含value也包含了接收方的地址
